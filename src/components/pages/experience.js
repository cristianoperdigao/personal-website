        ...
        return (
            <div className="experience-page">
                ...
                <Animated animationIn="fadeIn" animationOut="fadeOut" animationInDelay="400">
                    <Row className="d-block d-sm-none block-bottom-margin">
                        <Col>
                            <ul class="timeline">
                                <li>
                                    <a href="#">KWAN</a>
                                    <a href="#" class="float-right">Nov 2016 – Dec 2019</a><br/><br/>
                                ...
                                <li>
                                    <a href="#">iGame</a>
                                    <a href="#" class="float-right">Jun 2016 – Nov 2016</a><br /><br />
                                ...
                                <li>
                                    <a href="#">Bit8</a>
                                    <a href="#" class="float-right">Nov 2015 – May 2016</a><br /><br />
                                ...
                                <li>
                                    <a href="#">Futureway</a>
                                    <a href="#" class="float-right">Oct 2013 – Oct 2015</a><br /><br />
                                ...
                                <li>
                                    <a href="#">Simbiotic</a>
                                    <a href="#" class="float-right">May 2012 – Oct 2013</a><br /><br />
